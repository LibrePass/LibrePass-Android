...
import dev.medzik.librepass.android.ui.composable.TopBarTwoColor

@Composable
fun WelcomeScreen(navController: NavController) {
    // TODO: fix deprecated code
    val applicationInfo = navController.context.packageManager.getApplicationInfo(navController.context.packageName, 0)
